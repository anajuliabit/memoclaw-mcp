...
const TOOLS = [
    ...
    },
    {
        ...
        description: 'Export all memories as a JSON array or JSONL. Useful for backup, migration, or analysis. ' +
    ...
    },
    {
        ...
        description: 'List all distinct namespaces in your memory store. Useful for discovery — see what organizational ' +
    ...
    {
        name: 'memoclaw_tags',
        description: 'List all distinct tags across your memories with their frequency counts. ' +
    ...
    },
    {
        ...
        description: 'Store multiple memories in a single API call. More efficient than calling memoclaw_store multiple times. ' +
    ...
    {
        name: 'memoclaw_stats',
        description: 'Get statistics about your memory store: total count, breakdown by type/namespace/tags, ' +
